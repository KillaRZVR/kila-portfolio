...
import { SiteGeometry } from "@/components/site-geometry";
    ...
    <main className="relative isolate min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8">
        <section className="relative grid min-h-[clamp(20rem,52vh,34rem)] grid-cols-1 gap-4 pb-8 pt-2 lg:grid-cols-12 lg:gap-8">
          <div className="relative order-1 flex min-h-[18rem] items-center lg:col-span-6 lg:min-h-0">
            ...
            <div className="max-w-[46rem]">
              <h1 className="font-xanmono text-balance text-[clamp(2.25rem,3.65vw,3.7rem)] font-normal leading-[0.98] tracking-[-0.05em]">
                {siteData.heroNote}
              </h1>
        ...
        <section
          ...
          className="flex flex-col gap-5 border-y border-[#3c3c38] py-8 sm:flex-row sm:items-center sm:justify-between"
        >
          <p className="max-w-2xl text-xl leading-snug tracking-[-0.035em] sm:text-2xl">
