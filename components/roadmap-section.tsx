          ...
          <div className="min-w-0 lg:col-span-8 lg:pt-8">
            ...
            <div className="overflow-x-auto pb-3">
              <div className="min-w-[760px]">
                ...
                <div
                  className="relative grid gap-y-2 py-3"
                  style={{
                    gridTemplateColumns: "repeat(14, minmax(0, 1fr))",
                    gridTemplateRows: `repeat(${siteData.roadmap.items.length}, minmax(2.75rem, auto))`,
                  }}
                >
                  <div
            ...
            <div
              ...
              aria-live="polite"
              className="mt-1 border-l-2 border-[#f5c2c8] bg-[#1b1c18]/55 px-4 py-4"
            >
              <p className="font-telemetry text-[10px] uppercase text-[#f5c2c8]">
                Этап {String(activeIndex + 1).padStart(2, "0")} · День {activeItem.start}
